...
public class ProductReviewService : IProductReviewService
{
    ...
    {
        // Only one review per order/product/user
        ...
        return new ProductReviewDto
        {
            ...
            UserName = customer?.Username + " " + customer?.Surname
        };
    }

    public async Task<bool> HasReviewedAsync(int userId, int orderId, int productId)
    {
        return await _context.ProductReviews
            .AnyAsync(r => r.UserID == userId && r.OrderID == orderId && r.ProductID == productId);
    }
        ...
        return await _context.ProductReviews
            ...
            .Select(r => new ProductReviewDto
            {
                ...
                ProductImageUrl = r.Product.ProductImages.FirstOrDefault() != null
                    ? "/images/products/" + r.Product.ProductImages.FirstOrDefault().ImagePath
                    : null
            }).ToListAsync();
    }
